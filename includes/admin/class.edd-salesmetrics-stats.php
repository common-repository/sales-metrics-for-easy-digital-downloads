...
class EDD_Sales_Metrics_Stats {
	...
	public function get_predefined_dates() {
		$predefined = array(
			'today'        => __( 'Today',        'edd-sales-metrics' ),
			'yesterday'    => __( 'Yesterday',    'edd-sales-metrics' ),
			'this_week'    => __( 'This Week',    'edd-sales-metrics' ),
			'last_week'    => __( 'Last Week',    'edd-sales-metrics' ),
			'this_month'   => __( 'This Month',   'edd-sales-metrics' ),
			'last_month'   => __( 'Last Month',   'edd-sales-metrics' ),
			'this_quarter' => __( 'This Quarter', 'edd-sales-metrics' ),
			'last_quarter' => __( 'Last Quater',  'edd-sales-metrics' ),
			'this_year'    => __( 'This Year',    'edd-sales-metrics' ),
			'last_year'    => __( 'Last Year',    'edd-sales-metrics' )
		);
		// eturn apply_filters( 'edd_stats_predefined_dates', $predefined );
		return $predefined;
	}
	...
	public function convert_date( $date, $end_date = false ) {
		...
		if ( array_key_exists( $date, $this->get_predefined_dates() ) ) {
			...
			return new WP_Error( 'invalid_date', __( 'Improper date provided.', 'edd-sales-metrics' ) );
